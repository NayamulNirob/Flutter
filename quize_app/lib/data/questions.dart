...
var questions = [
  ...
  QuizQuestion(
    'What is the main function of the "Scaffold" widget in Flutter?',
    [
  ...
  QuizQuestion(
    'How can you listen for changes in the state of a Flutter app?',
    [
  ...
  QuizQuestion(
    'What is the default behavior of the "Expanded" widget in Flutter?',
    [
  ...
  QuizQuestion(
    'Which of the following widgets is used to create a scrollable view in Flutter?',
    ['ListView', 'Stack', 'Column', 'Container'],
  ),

  QuizQuestion(
    'What is the primary use of the "TextEditingController" in Flutter?',
    [
  ...
  QuizQuestion(
    'Which of the following is a way to create a floating action button in Flutter?',
    [
  ...
  QuizQuestion(
    'Which widget is used to create a horizontal scrollable list in Flutter?',
    ['ListView.horizontal', 'Row', 'SingleChildScrollView', 'GridView'],
  ),

  QuizQuestion(
    'Which of the following is a way to add padding around a widget in Flutter?',
    [
  ...
  QuizQuestion(
    'Which of the following allows asynchronous data to be displayed in Flutter?',
    ['FutureBuilder', 'ListView', 'GridView', 'Text'],
  ),
  ...
  QuizQuestion(
    'Which of the following is used to pass data between screens in Flutter?',
    [
  ...
  QuizQuestion(
    'Which of the following widgets is used to create a dialog in Flutter?',
    ['AlertDialog', 'DialogBox', 'PopupMenu', 'SnackBar'],
  ),

  QuizQuestion(
    'Which widget is used for creating a scrollable column of widgets in Flutter?',
    ['SingleChildScrollView', 'Column', 'Stack', 'Row'],
  ),

  QuizQuestion(
    'Which of the following is used to navigate back in the app in Flutter?',
    [
      'Navigator.pop()',
      'Navigator.push()',
      'Navigator.pushNamed()',
  ...
  QuizQuestion(
    'Which widget is used for displaying a simple text input field?',
    ['TextField', 'TextFormField', 'Column', 'Form'],
  ),

  QuizQuestion(
    'Which of the following widgets is used to display an icon in Flutter?',
    ['Icon', 'Text', 'Container', 'Column'],
  ),

  QuizQuestion(
    'Which of the following is used to manage the lifecycle of a StatefulWidget in Flutter?',
    [
  ...
  QuizQuestion(
    'Which of the following is used to create an input form with validation in Flutter?',
    [
  ...
  QuizQuestion(
    'Which widget is used to create a card-like UI element in Flutter?',
    ['Card', 'Container', 'Column', 'Text'],
  ),
  ...
  QuizQuestion(
    'Which widget is used for creating a button with a custom shape in Flutter?',
    ['MaterialButton', 'FlatButton', 'RaisedButton', 'IconButton'],
  ),
  ...
  QuizQuestion(
    'Which of the following is used to handle HTTP requests in Flutter?',
    ['http package', 'url_launcher', 'connectivity package', 'firebase_auth'],
  ),

  QuizQuestion(
    'What is the primary function of the "IconButton" widget in Flutter?',
    [
  ...
  QuizQuestion(
    'Which of the following can be used to display a list of items with a custom layout in Flutter?',
    ['CustomScrollView', 'ListView', 'Column', 'GridView'],
  ),
  ...
  QuizQuestion(
    'Which widget is used to create a simple toggle button in Flutter?',
    ['Switch', 'Slider', 'RadioButton', 'Button'],
  ),

  QuizQuestion(
    'What is the role of the "Expanded" widget in a Row widget in Flutter?',
    [
  ...
  QuizQuestion(
    'Which widget is used to wrap text into multiple lines in Flutter?',
    ['TextOverflow', 'Text', 'RichText', 'TextField'],
  ),
  ...
  QuizQuestion(
    'Which of the following widgets is used to display a bottom navigation bar in Flutter?',
    ['BottomNavigationBar', 'BottomSheet', 'Drawer', 'BottomAppBar'],
  ),
  ...
  QuizQuestion(
    'Which of the following widgets is used to create a row of widgets in Flutter?',
    ['Row', 'Column', 'Stack', 'GridView'],
  ),

  QuizQuestion(
    'Which package is used to access native device features like camera or sensors in Flutter?',
    [
  ...
  QuizQuestion(
    'Which widget is used for creating an image from a network URL in Flutter?',
    ['Image.network', 'NetworkImage', 'Image.asset', 'Image.file'],
  ),

  QuizQuestion(
    'What is the purpose of "Navigator.pushReplacement" in Flutter?',
    [
  ...
  QuizQuestion(
    'Which widget is used to create a grid view of items in Flutter?',
    ['GridView', 'Column', 'Row', 'Stack'],
  ),
  ...
  QuizQuestion(
    'Which of the following is used to store and access small pieces of data in Flutter?',
    ['SharedPreferences', 'SQLite', 'Firebase', 'CloudStorage'],
  ),
  ...
  QuizQuestion(
    'Which widget is used to create a container with constraints in Flutter?',
    ['ConstrainedBox', 'Container', 'SizedBox', 'TextField'],
  ),

  QuizQuestion(
    'What is the function of the "Navigator.pushReplacementNamed" method in Flutter?',
    [
  ...
  QuizQuestion(
    'Which widget is used to create a scrollable grid of items in Flutter?',
    ['GridView', 'Row', 'Column', 'Stack'],
  ),
  ...
  QuizQuestion(
    'Which widget is used to display a simple text label in Flutter?',
    ['Text', 'TextField', 'Column', 'Row'],
  ),

  QuizQuestion(
    'Which widget is used to display a list of items with the ability to scroll in Flutter?',
    ['ListView', 'Column', 'GridView', 'Stack'],
  ),
  ...
  QuizQuestion(
    'Which widget is used to create a button with custom behavior in Flutter?',
    ['FlatButton', 'RaisedButton', 'MaterialButton', 'IconButton'],
  ),

  QuizQuestion(
    'Which method is used to trigger a rebuild of a StatefulWidget in Flutter?',
    ['setState()', 'rebuild()', 'updateState()', 'resetState()'],
  ),
  ...
  QuizQuestion(
    'Which widget is used to display a horizontally scrollable list in Flutter?',
    ['ListView.horizontal', 'GridView', 'Row', 'SingleChildScrollView'],
  ),

  QuizQuestion(
    'Which class in Flutter is used to manage theme data for the app?',
    ['ThemeData', 'MaterialTheme', 'AppTheme', 'AppSettings'],
  ),
];
